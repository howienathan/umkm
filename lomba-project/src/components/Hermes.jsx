    ...
    return (
      ...
      <img src={cover} alt="" className='shadow-[-10px_20px_22px_0px_#edf2f7]'/>
        ...
        <div className="max-w-7xl mx-auto px-4 grid gap-5">
            <img src={hermes} alt="" className="shadow-[0px_7px_21px_4px_#f7fafc] rounded-md flex justify-self-center" />
            <h1 className='text-2xl font-semibold font-Lora text-center'>Hermes - God Of Messengers</h1>
          <p className="text-base font-jakarta text-center">
          considered the messenger of the Olympic gods. According to legend, he was the son of Zeus, king of Mount Olympus, and Maia, a nymph. As time went on, he was also associated with luck, shepherds, athletes, thieves, and merchants.
          </p>
        </div>
        </div>
        <Pilihan/>
